  ...
  const handleSend = (content: string) => {
    ...
    chat.mutate({ sessionId, message: content }, {
      onSuccess: (result) => {
        ...
        if (result.leadCreated) setLeadCreated(true);
      },
